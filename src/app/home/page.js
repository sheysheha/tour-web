      ...
      <section className="relative py-0 overflow-hidden">
        <div className="bg-cyan-50 py-16 px-4 md:px-8">
          ...
          <div className='grid grid-cols-3'>
            <div className='col-span-1 bg-cyan-700 w-[100%]' onClick={()=>{setIsRoundTripsClicked(true);}}>Round Trips</div>
            <div className='col-span-1 bg-cyan-700 w-[100%]'>Transfers</div>
            {/* airport to colombo or airport to Galle airport to Negombo etc...*/}
            <div className='col-span-1 bg-cyan-700 w-[100%]'>Excursions</div> 
            {/* city tours  */}
          </div>
          {isRounTripsClicked && (<div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <motion.h2
                initial={{ opacity: 0, y: -20 }}
                animate={{ opacity: 1, y: 0 }}
